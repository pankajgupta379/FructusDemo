...
let fruitsData: [Fruit] = [
  Fruit(
      ...
      description: """
        ...
        """,
      nutrition: [
        FruitNutrients(name: "Energy", value: "240 kJ (57 kcal)"),
        FruitNutrients(name: "Sugar", value: "9.96 g"),
        FruitNutrients(name: "Fat", value: "0.33 g"),
        FruitNutrients(name: "Protien", value: "0.74 g"),
        FruitNutrients(name: "Vitamins", value: "A, B1, B2, B3, B5, B6, B9, C, E, K"),
        FruitNutrients(name: "Minirals", value: "Calcium, Iron, Magnasium, Manganese, Phosphorus, Sodium, Zinc")
      ]
    ),
    Fruit(
      title: "Strawberry",
      ...
      description: """
        ...
        """,
      nutrition: [
        FruitNutrients(name: "Energy", value: "136 kJ (33 kcal)"),
        FruitNutrients(name: "Sugar", value: "4.89 g"),
        FruitNutrients(name: "Fat", value: "0.3 g"),
        FruitNutrients(name: "Protien", value: "0.67 g"),
        FruitNutrients(name: "Vitamins", value: "B1, B2, B3, B5, B6, B9, Choline, C, E, K"),
        FruitNutrients(name: "Minirals", value: "Calcium, Iron, Magnasium, Manganese, Phosphorus, Potassium, Sodium, Zinc")
      ]
    ),
    Fruit(
      title: "Lemon",
      ...
      description: """
        ...
        """,
      nutrition: [
        FruitNutrients(name: "Energy", value: "121 kJ (29 kcal)"),
        FruitNutrients(name: "Sugar", value: "2.5 g"),
        FruitNutrients(name: "Fat", value: "0.3 g"),
        FruitNutrients(name: "Protien", value: "1.1 g"),
        FruitNutrients(name: "Vitamins", value: "B1, B2, B3, B5, B6, B9, C, Choline"),
        FruitNutrients(name: "Minirals", value: "Calcium, Iron, Magnasium, Manganese, Phosphorus, Potassium, Zinc")
      ]
    ),
    Fruit(
      title: "Plum",
      ...
      description: """
        ...
        """,
      nutrition: [
        FruitNutrients(name: "Energy", value: "192 kJ (46 kcal)"),
        FruitNutrients(name: "Sugar", value: "9.92 g"),
        FruitNutrients(name: "Fat", value: "0.28 g"),
        FruitNutrients(name: "Protien", value: "0.7 g"),
        FruitNutrients(name: "Vitamins", value: "B1, B2, B3, B5, B6, B9, C"),
        FruitNutrients(name: "Minirals", value: "Calcium, Iron, Magnasium, Manganese, Phosphorus, Potassium, Sodium, Zinc")
      ]
    ),
    Fruit(
      ...
      """,
      nutrition: [
        FruitNutrients(name: "Energy", value: "126 kJ (30 kcal)"),
        FruitNutrients(name: "Sugar", value: "1.7 g"),
        FruitNutrients(name: "Fat", value: "0.2 g"),
        FruitNutrients(name: "Protien", value: "0.7 g"),
        FruitNutrients(name: "Vitamins", value: "B1, B2, B3, B5, B6, B9, C"),
        FruitNutrients(name: "Minirals", value: "Calcium, Iron, Magnasium, Phosphorus, Potassium, Sodium")
      ]
    ),
    Fruit(
      title: "Pomegranate",
      ...
      description: """
        ...
        """,
      nutrition: [
        FruitNutrients(name: "Energy", value: "346 kJ (83 kcal)"),
        FruitNutrients(name: "Sugar", value: "13.67 g"),
        FruitNutrients(name: "Fat", value: "1.17 g"),
        FruitNutrients(name: "Protien", value: "1.67 g"),
        FruitNutrients(name: "Vitamins", value: "B1, B2, B3, B5, B6, B9, C, E, K"),
        FruitNutrients(name: "Minirals", value: "Calcium, Iron, Magnasium, Manganese, Phosphorus, Potassium, Sodium, Zinc")
      ]
    ),
    Fruit(
      ...
      description: """
        ...
        """,
      nutrition: [
        FruitNutrients(name: "Energy", value: "239 kJ (57 kcal)"),
        FruitNutrients(name: "Sugar", value: "9.75 g"),
        FruitNutrients(name: "Fat", value: "0.14 g"),
        FruitNutrients(name: "Protien", value: "0.36 g"),
        FruitNutrients(name: "Vitamins", value: "B1, B2, B3, B5, B6, B9, C, E, K"),
        FruitNutrients(name: "Minirals", value: "Calcium, Iron, Magnasium, Manganese, Phosphorus, Potassium, Sodium, Zinc")
      ]
    ),
...
let settingsRowData: [SettingsRowModel] = [
    SettingsRowModel(name: "Developer", content: "John / Jane"),
    SettingsRowModel(name: "Designer", content: "Robert Petras"),
    SettingsRowModel(name: "Compatibility", content: "iOS"),
    SettingsRowModel(name: "Website", linkLabel: "SwiftUI Masterclass", linkDestination: "swiftuimasterclass.com"),
    SettingsRowModel(name: "Twitter", linkLabel: "@RobertPetras", linkDestination: "twitter.com/robertpetras"),
    SettingsRowModel(name: "SwiftUI", content: "2.0"),
    SettingsRowModel(name: "Version", content: "1.1.0")
]
